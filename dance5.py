...
dance2_phases = {
    1: {0: 170, 1: 70, 2: 50, 4: 100, 5: 55, 6: 110, 8: 150, 9: 83, 10: 50, 12: 115, 13: 57, 14: 105},  # Standing
    2: {0: 170, 1: 90, 2: 70, 4: 100, 5: 35, 6: 90, 8: 150, 9: 63, 10: 20, 12: 115, 13: 77, 14: 135},  # Bending back knees
    3: {0: 170, 1: 10, 2: 150, 4: 100, 5: 115, 6: 10, 8: 150, 9: 63, 10: 20, 12: 115, 13: 77, 14: 135},  # Bending front hip
    4: {0: 170, 1: 10, 2: 150, 4: 100, 5: 115, 6: 10, 8: 150, 9: 13, 10: 0, 12: 115, 13: 127, 14: 155},  # Bending back hip and knee
    5: {0: 170, 1: 80, 2: 150, 4: 100, 5: 45, 6: 10, 8: 150, 9: 43, 10: 0, 12: 115, 13: 97, 14: 155},  # Bending front hip
    6: {0: 170, 1: 55, 2: 70, 4: 100, 5: 70, 6: 90, 8: 150, 9: 43, 10: 0, 12: 115, 13: 97, 14: 155},  # Bending front knee
    7: {0: 170, 1: 55, 2: 70, 4: 100, 5: 70, 6: 90, 8: 150, 9: 43, 10: 0, 12: 115, 13: 97, 14: 155},  # Bending
    8: {0: 195, 1: 10, 2: 91, 4: 72, 5: 115, 6: 63, 8: 150, 9: 43, 10: 0, 12: 115, 13: 97, 14: 155},  # Bending front shoulders
    9: {0: 150, 1: 55, 2: 70, 4: 120, 5: 70, 6: 90, 8: 150, 9: 43, 10: 0, 12: 115, 13: 97, 14: 155},  # Bending front shoulders
    10: {0: 170, 1: 55, 2: 70, 4: 100, 5: 70, 6: 90, 8: 150, 9: 43, 10: 0, 12: 115, 13: 97, 14: 155},  # Bending
    11: {0: 230, 1: 55, 2: 0, 4: 160, 5: 70, 6: 160, 8: 150, 9: 43, 10: 0, 12: 115, 13: 97, 14: 155},  # Bending front shoulders, knee
    12: {0: 230, 1: 55, 2: 70, 4: 160, 5: 70, 6: 90, 8: 150, 9: 43, 10: 0, 12: 115, 13: 97, 14: 155},  # Bending front knees
    13: {0: 110, 1: 55, 2: 0, 4: 40, 5: 70, 6: 160, 8: 150, 9: 43, 10: 0, 12: 115, 13: 97, 14: 155},  # Bending front knees
    14: {0: 110, 1: 55, 2: 70, 4: 40, 5: 70, 6: 90, 8: 150, 9: 43, 10: 0, 12: 115, 13: 97, 14: 155},  # Bending front knees
    15: {0: 170, 1: 55, 2: 70, 4: 100, 5: 70, 6: 90, 8: 150, 9: 43, 10: 0, 12: 115, 13: 97, 14: 155},  # Bending
    16: {0: 170, 1: 55, 2: 70, 4: 100, 5: 70, 6: 90, 8: 150, 9: 0, 10: 0, 12: 115, 13: 140, 14: 155},  # Back hip
    17: {0: 170, 1: 10, 2: 150, 4: 100, 5: 115, 6: 10, 8: 150, 9: 0, 10: 0, 12: 115, 13: 140, 14: 155},  # Front straight
    18: {0: 170, 1: 10, 2: 150, 4: 100, 5: 115, 6: 10, 8: 150, 9: 83, 10: 0, 12: 115, 13: 57, 14: 155},  # Back hip adjust
    19: {0: 170, 1: 70, 2: 150, 4: 100, 5: 55, 6: 10, 8: 150, 9: 83, 10: 0, 12: 115, 13: 57, 14: 155},  # Transition to standing
    20: {0: 170, 1: 70, 2: 50, 4: 100, 5: 55, 6: 110, 8: 150, 9: 83, 10: 50, 12: 115, 13: 57, 14: 105}  # Standing
}
...
def dance(cycles=1):
    print("Starting dance mode...")
    set_pose(stand_angles, transition_time=0.3)  # Start from stand position
    
    for _ in range(cycles):
        # Phase 1
        set_pose(dance_phases[1], transition_time=1.0)
        time.sleep(1.0)
        
        # Phases 2 and 3 continuous loop (slow transitions)
        for _ in range(3):  # 2→3→2→3→2→3 (3 cycles)
            set_pose(dance_phases[2], transition_time=1.5)
            time.sleep(1.5)
            set_pose(dance_phases[3], transition_time=1.5)
            time.sleep(1.5)
        
        # Phase 4
        set_pose(dance_phases[4], transition_time=1.0)
        time.sleep(1.0)
        
        # Phase 5
        set_pose(dance_phases[5], transition_time=1.0)
        time.sleep(1.0)
    
    set_pose(stand_angles, transition_time=0.3)
    print("Dance mode complete.")

def dance2(cycles=1):
    print("Starting dance mode 2...")
    set_pose(stand_angles, transition_time=0.3)  # Start from stand position
    
    for _ in range(cycles):
        # Phase 1: Standing
        set_pose(dance2_phases[1], transition_time=2.0)
        time.sleep(2.0)
        
        # Phase 2: Bending back knees
        set_pose(dance2_phases[2], transition_time=2.0)
        time.sleep(2.0)
        
        # Phase 3: Bending front hip
        set_pose(dance2_phases[3], transition_time=2.0)
        time.sleep(2.0)
        
        # Phase 4: Bending back hip and knee
        set_pose(dance2_phases[4], transition_time=2.0)
        time.sleep(2.0)
        
        # Phase 5: Bending front hip
        set_pose(dance2_phases[5], transition_time=2.0)
        time.sleep(2.0)
        
        # Phase 6: Bending front knee
        set_pose(dance2_phases[6], transition_time=2.0)
        time.sleep(2.0)
        
        # Phase 7: Bending
        set_pose(dance2_phases[7], transition_time=2.0)
        time.sleep(2.0)
        
        # Phases 8 and 9 loop (7 times: 8→9→8→9→8→9→8)
        for _ in range(7):
            set_pose(dance2_phases[8], transition_time=2.0)
            time.sleep(2.0)
            set_pose(dance2_phases[9], transition_time=2.0)
            time.sleep(2.0)
        
        # Phase 10: Bending
        set_pose(dance2_phases[10], transition_time=2.0)
        time.sleep(2.0)
        
        # Phases 11 and 12 loop (3 times: 11→12→11→12→11→12)
        for _ in range(3):
            set_pose(dance2_phases[11], transition_time=2.0)
            time.sleep(2.0)
            set_pose(dance2_phases[12], transition_time=2.0)
            time.sleep(2.0)
        
        # Phase 13: Bending front knees
        set_pose(dance2_phases[13], transition_time=2.0)
        time.sleep(2.0)
        
        # Phase 14: Bending front knees
        set_pose(dance2_phases[14], transition_time=2.0)
        time.sleep(2.0)
        ...
        # Phase 15: Bending
        set_pose(dance2_phases[15], transition_time=2.0)
        time.sleep(2.0)
        
        # Phase 16: Back hip
        set_pose(dance2_phases[16], transition_time=2.0)
        time.sleep(2.0)
        
        # Phase 17: Front straight
        set_pose(dance2_phases[17], transition_time=2.0)
        time.sleep(2.0)
        
        # Phase 18: Back hip adjust
        set_pose(dance2_phases[18], transition_time=2.0)
        time.sleep(2.0)
        
        # Phase 19: Transition to standing
        set_pose(dance2_phases[19], transition_time=2.0)
        time.sleep(2.0)
        
        # Phase 20: Standing
        set_pose(dance2_phases[20], transition_time=2.0)
        time.sleep(2.0)
    
    set_pose(stand_angles, transition_time=0.3)
    print("Dance mode 2 complete.")
...
# Main program
print("Quadruped Robot: Straight / Stand / Sit / Walk / Turn Right / Turn Left / Dance / Dance2 / Test Distance / Quit")
...
try:
    while True:
        cmd = input("Enter mode (straight/stand/sit/walk/right/left/dance/dance2/distance/q): ").strip().lower()
        if cmd == 'q':
            break
        elif cmd == 'straight':
            ...
            dance(cycles=1)
            input("Dance finished. Press Enter to continue.")
        elif cmd == 'dance2':
            dance2(cycles=1)
            ...
            print("Invalid command. Use: straight/stand/sit/walk/right/left/dance/dance2/distance/q")
finally:
