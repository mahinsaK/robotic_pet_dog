...
dance2_phases = {
    ...
    16: {0: 170, 1: 55, 2: 70, 4: 100, 5: 70, 6: 90, 8: 150, 9: 43, 10: 0, 12: 115, 13: 97, 14: 155},
    17: {0: 170, 1: 80, 2: 150, 4: 100, 5: 45, 6: 10, 8: 150, 9: 43, 10: 0, 12: 115, 13: 97, 14: 155},
    18: {0: 170, 1: 10, 2: 150, 4: 100, 5: 115, 6: 10, 8: 150, 9: 13, 10: 0, 12: 115, 13: 127, 14: 155},
    19: {0: 170, 1: 10, 2: 150, 4: 100, 5: 115, 6: 10, 8: 150, 9: 63, 10: 20, 12: 115, 13: 77, 14: 135},
    20: {0: 170, 1: 90, 2: 70, 4: 100, 5: 35, 6: 90, 8: 150, 9: 63, 10: 20, 12: 115, 13: 77, 14: 135},
...
def dance2(cycles=1):
    ...
    sequence = [
        1, 2, 3, 4, 5, 6, 7, 8, 9,  # Initial phases
        8, 9, 8, 9, 8, 9,           # Phase 8 → 9 repeated three times
        10, 11, 12,                  # Continue with phases
        11, 12, 11, 12, 11, 12,     # Phase 11 → 12 repeated three times
        13, 14, 13, 14, 13, 14, 13, # Phase 13 → 14 repeated twice, then 13
        15, 16, 17, 18, 19, 20, 21, # Final phases
        22, 21                       # Phase 22 and return to 21 (standing)
    ]
    
    for phase_num in sequence:
        set_pose(dance2_phases[phase_num], transition_time=1.5)
        time.sleep(1.5)
...
def dance3(cycles=1):
    ...
    sequence = [
        1, 2, 3,               # Initial phases
        2, 3, 2, 3, 2, 3,     # Phase 2 → 3 repeated three times
        4                      # Final phase (standing)
    ]
    
    for phase_num in sequence:
        set_pose(dance3_phases[phase_num], transition_time=1.5)
        time.sleep(1.5)
...
print("💃 Dance mode: Runs all three dance sequences sequentially")
