...
# Main program
print("Quadruped Robot: Stand / Sit / Walk / Turn Right / Turn Left / Test Distance / Quit")
print("🚨 Obstacle avoidance enabled - robot will automatically turn right when obstacles detected within 30cm during walking")

try:
    while True:
        cmd = input("Enter mode (stand/sit/walk/right/left/distance/q): ").strip().lower()
        if cmd == 'q':
            break
        elif cmd == 'stand':
            ...
            walk_trot(cycles=50, enable_obstacle_avoidance=True)
            ...
            print("Invalid command. Use: stand/sit/walk/right/left/distance/q")
finally:
