...
PITCH_PID_PARAMS = {
    'kp': 0.4,  # Proportional gain for pitch correction
...
# Main program
print("🤖 Quadruped Robot with CONTINUOUS Balance Control (Version 2)")
print("🔄 NEW: Balance corrections applied DURING servo movements, not just at the start!")
...
print("   - All movement commands now support CONTINUOUS balance control")
    ...
    while True:
        ...
        if cmd == 'q':
            ...
            if balance_choice == 'c':
                ...
                if enable_balance:
                    print("Stand pose set with continuous balance correction applied during movement.")
                else:
