...
dance3_phases = {
    ...
    2: {
        0: 170, 1: 70, 2: 50, 4: 100, 5: 55, 6: 110,
        8: 150, 9: 123, 10: 10, 12: 115, 13: 17, 14: 145
    },
    3: {
        0: 170, 1: 110, 2: 10, 4: 100, 5: 15, 6: 150,
        8: 150, 9: 83, 10: 50, 12: 115, 13: 57, 14: 105
    },
    4: {
        0: 170, 1: 70, 2: 50, 4: 100, 5: 55, 6: 110,
...
def dance3(cycles=1):
    print("Starting dance mode 3...")
    set_pose(stand_angles, transition_time=0.3)  # Start from stand position
    
    for _ in range(cycles):
        # Phase 1
        set_pose(dance3_phases[1], transition_time=1.0)
        time.sleep(1.0)
        
        # Phases 2 and 3 continuous loop (slow transitions)
        for _ in range(4):  # 2→3→2→3→2→3→2→3 (4 cycles)
            set_pose(dance3_phases[2], transition_time=1.5)
            time.sleep(1.5)
            set_pose(dance3_phases[3], transition_time=1.5)
            time.sleep(1.5)
        
        # Phase 4
        set_pose(dance3_phases[4], transition_time=1.0)
        time.sleep(1.0)
    
    set_pose(stand_angles, transition_time=0.3)
    print("Dance mode 3 complete.")
...
# Main program
print("Quadruped Robot: Straight / Stand / Sit / Walk / Turn Right / Turn Left / Dance / Dance3 / Test Distance / Quit")
...
try:
    while True:
        cmd = input("Enter mode (straight/stand/sit/walk/right/left/dance/dance3/distance/q): ").strip().lower()
        if cmd == 'q':
            break
        elif cmd == 'straight':
            ...
            print("Invalid command. Use: straight/stand/sit/walk/right/left/dance/dance3/distance/q")
finally:
