...
dance2_phases = {
    ...
    7: {0: 170, 1: 55, 2: 70, 4: 100, 5: 70, 6: 90, 8: 150, 9: 43, 10: 0, 12: 115, 13: 97, 14: 155},  # Bending (same as phase 6)
    ...
    19: {0: 170, 1: 70, 2: 50, 4: 100, 5: 55, 6: 110, 8: 150, 9: 83, 10: 50, 12: 115, 13: 57, 14: 105}  # Standing
}
...
def dance2(cycles=1):
    ...
    for _ in range(cycles):
        ...
        # Phase 7: Bending (same as phase 6)
        set_pose(dance2_phases[7], transition_time=2.0)
        time.sleep(2.0)
        
        # Phases 8 and 9 loop (7 times)
        for _ in range(7):  # 8→9→8→9→8→9→8
        ...
        # Phases 11 and 12 loop (3 times)
        for _ in range(3):  # 11→12→11→12→11→12
        ...
        # Phases 13 and 14 loop (2 times)
        for _ in range(2):  # 13→14→13→14
            set_pose(dance2_phases[13], transition_time=2.0)
            time.sleep(2.0)
            set_pose(dance2_phases[14], transition_time=2.0)
            time.sleep(2.0)
