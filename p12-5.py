...
# Main program
print("Quadruped Robot: Stand / Sit / Walk / Turn Right / Turn Left / Quit")

try:
    while True:
        cmd = input("Enter mode (stand/sit/walk/right/left/q): ").strip().lower()
        if cmd == 'q':
            break
        elif cmd == 'stand':
            ...
            print("Invalid command. Use: stand/sit/walk/right/left/q")
finally:
