...
# Initialize MPU-6050
try:
    sensor = mpu6050(0x68)  # Default I2C address for MPU-6050
...
def get_balance_adjustments(pitch, roll):
    ...
    if effective_pitch != 0:
        ...
        if effective_pitch < 0:  # Negative pitch
    ...
    if effective_roll != 0:
        ...
        if effective_roll > 0:  # Positive roll
            ...
            adjustments[channels['RR_shoulder']] -= roll_adjustmentp
...
def calculate_pitch_roll(accel_data, gyro_data):
