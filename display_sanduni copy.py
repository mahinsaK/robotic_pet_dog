...
# Ensure GPIO mode is set globally for luma/lcd usage
try:
...
class RoboEyes:
    ...
    def _draw_eye(self, draw, pos, is_left):
        ...
        if self.blinking:
            ...
            draw.rectangle((eye_x, eye_y, eye_x + eye_w, eye_y + lid_height), fill=(255, 255, 255))
            draw.rectangle((eye_x, eye_y + eye_h - lid_height, eye_x + eye_w, eye_y + eye_h), fill=(255, 255, 255))
            return
